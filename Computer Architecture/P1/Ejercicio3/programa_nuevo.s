...
main:
  ...
  # comprobacion de operaciones nuevas
  slti $t0, $t3, 5 # slti $t0, $t1, 2  -> r10=1 si r8 < 2 else 0 = 1
  addi $t0, $t3, 1 # addi $t0, $t1, 0 -> r8 = r10 + 1 = 5
  andi $t0, $t3, 0 # andi $t0, $t1, 0 -> r8 = (r9 and 0) = 0
  j final # j 0 -> pc = final
  nop
  nop
